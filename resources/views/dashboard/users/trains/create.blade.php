        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card my-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('usersTrain.store') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <input id="date" type="date" class="form-control border border-2 p-2 @error('date') is-invalid @enderror" name="date" value="{{ old('date') }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <input id="time" type="time" class="form-control border border-2 p-2 @error('time') is-invalid @enderror" name="time" value="{{ old('time') }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <input id="duration" type="number" class="form-control border border-2 p-2 @error('duration') is-invalid @enderror" name="duration" value="{{ old('duration') }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <textarea id="notes" class="form-control border border-2 p-2 @error('notes') is-invalid @enderror" name="notes" required>{{ old('notes') }}</textarea>
