<x-app-layout>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Update Training Plan</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('trains.update', $train) }}">
                            @csrf
                                ...
                                <div class="mb-3 col-md-6">
                                    <select id="muscle_id" class="form-control border border-2 p-2 @error('muscle_id') is-invalid @enderror" name="muscle_id" required>
                                        ...
                                        @foreach($muscles as $muscle)
                                            <option value="{{ $muscle->id }}" @if ($train->muscle_id==$muscle->id)
                                                selected
                                            @endif>{{ $muscle->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <input id="level" type="text" class="form-control border border-2 p-2 @error('level') is-invalid @enderror" name="level" value="{{ old('level', $train->level) }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <input id="title" type="text" class="form-control border border-2 p-2 @error('title') is-invalid @enderror" name="title" value="{{ old('title', $train->title) }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <textarea id="description" class="form-control border border-2 p-2 @error('description') is-invalid @enderror" name="description" required>{{ old('description', $train->description) }}</textarea>
