            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="hero-text">
                        ...
                        <p>Welcome to a life of health and fitness, and from here your journey begins to achieve your goals to achieve a healthy body
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about-text">
                        ...
                        <p class="first-para">Fitness and exercise are an essential part of a healthy person's life. Therefore, our goal was to provide an innovative technological solution that makes it easier for users to choose appropriate sports activities and customize their exercises according to their goals, and we worked on that until we achieved what you see now..</p>
